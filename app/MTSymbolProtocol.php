...
class  MTEnCalcMode
  ...
  const TRADE_MODE_EXCH_LAST  = MTEnCalcMode::TRADE_MODE_EXCH_BONDS;
  //--- service modes
...
class MTConSymbol
  ...
  public static function CreateDefault()
    ...
    $symbol->TradeFlags            = MTEnTradeFlags::TRADEFLAGS_NONE;
    $symbol->Spread                = 0;
    ...
    $symbol->SwapShort             = 0;
    $symbol->Swap3Day              = 3;
    $symbol->OrderFlags            = MTEnOrderFlags::ORDER_FLAGS_NONE;
